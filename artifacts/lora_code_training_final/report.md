...
|---|---:|---:|---:|---:|---:|---:|---:|
| sync | 0.8021 | 1.000 | 0.244 | 1.000 | 0.000 | 0.055 | 0.0382 |
| naive_async | 0.8277 | 1.032 | 0.277 | 1.137 | 0.210 | 0.059 | 0.0291 |
| stale_filter | 0.8277 | 1.032 | 0.277 | 1.137 | 0.210 | 0.060 | 0.0291 |
| random_filter | 0.8277 | 1.032 | 0.277 | 1.137 | 0.210 | 0.059 | 0.0291 |
## LoRA training
...
Mean per-run wall time was **7.100s**: sampling/inference 0.199s, local policy updates 0.947s, and verification 0.008s. Raw profiles are stored beside each run summary.
...
```bash
python3 -m staleroll.cli run --policy lora --task-domain code --seeds 3 --tasks 100 --workers 2 --ticks 96 --batch-size 4 --max-delay 8 --max-lag 0 --max-kl 0.2 --lora-rank 8 --lora-alpha 16.0 --lora-warmup-epochs 3 --checkpoint-interval 10 --eval-interval 10 --output artifacts/lora_code_training
```
