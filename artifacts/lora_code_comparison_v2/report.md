...
|---|---:|---:|---:|---:|---:|---:|---:|
| sync | 0.5469 | 1.000 | 0.161 | 1.000 | 0.000 | 0.087 | 0.0938 |
| naive_async | 0.5443 | 0.995 | 0.181 | 1.123 | 0.176 | 0.059 | 0.0217 |
| stale_filter | 0.5443 | 0.995 | 0.181 | 1.123 | 0.176 | 0.059 | 0.0217 |
| random_filter | 0.5443 | 0.995 | 0.181 | 1.123 | 0.176 | 0.060 | 0.0217 |
## LoRA training
...
Mean per-run wall time was **4.112s**: sampling/inference 0.138s, local policy updates 0.956s, and verification 0.005s. Raw profiles are stored beside each run summary.
...
```bash
python3 -m staleroll.cli run --policy lora --task-domain code --seeds 2 --tasks 50 --workers 2 --ticks 64 --batch-size 4 --max-delay 8 --max-lag 0 --max-kl 0.2 --lora-rank 8 --lora-alpha 16.0 --lora-warmup-epochs 3 --checkpoint-interval 5 --eval-interval 5 --output artifacts/lora_code_training
```
