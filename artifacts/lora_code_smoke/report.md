...
|---|---:|---:|---:|---:|---:|---:|---:|
| sync | 0.2969 | 1.000 | 0.090 | 1.000 | 0.000 | 0.000 | 0.2188 |
| naive_async | 0.3043 | 1.025 | 0.092 | 1.018 | 0.174 | 0.000 | 0.2174 |
| stale_filter | 0.3043 | 1.025 | 0.092 | 1.018 | 0.174 | 0.000 | 0.2174 |
| random_filter | 0.3043 | 1.025 | 0.092 | 1.018 | 0.174 | 0.000 | 0.2174 |
## LoRA training
...
Mean per-run wall time was **3.350s**: sampling/inference 0.133s, local policy updates 1.018s, and verification 0.005s. Raw profiles are stored beside each run summary.
